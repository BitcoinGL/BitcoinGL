Contributing to bitcoinglobal Core
============================

The bitcoinglobal Core project operates an open contributor model where anyone is
...
The following applies to code changes to the bitcoinglobal Core project, and is not to be
confused with overall bitcoinglobal Network Protocol consensus changes.

Whether a pull request is merged into bitcoinglobal Core rests with the project merge
...
Patches that change bitcoinglobal consensus rules are considerably more involved than
...
Where a patch set proposes to change the bitcoinglobal consensus, it must have been
...
The project leader is the release manager for each bitcoinglobal Core release.
